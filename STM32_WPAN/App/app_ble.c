...
/* USER CODE BEGIN PTD */
#define MAX_DEVICES 8  // 最大接続デバイス数
typedef struct {
...
//      CONFIG_DATA_LL_SCAN_CHAN_MAP_OFFSET,
//      1,
//      (uint8_t[]){0x07} // チャネル 37, 38, 39 のみを有効にする（Bluetooth 4.0 用）
//  );
//  if (ret != BLE_STATUS_SUCCESS)
//  {
//    APP_DBG_MSG("  Fail   : aci_hal_write_config_data command - CONFIG_DATA_LL_SCAN_CHAN_MAP_OFFSET, result: 0x%x \n", ret);
//  }
//  else
//  {
//    APP_DBG_MSG("  Success: aci_hal_write_config_data command - CONFIG_DATA_LL_SCAN_CHAN_MAP_OFFSET\n");
//  }
